  ...
  try {
    ...
    if (type === 'TEMPLATE') {
      ...
      **هام جداً:** 
      ...
      2- **يجب** وضع كافة المتغيرات والمعادلات والرموز الرياضية بين علامتي $ (ضمن JSON Quotes). أوامر LaTeX تحتاج Double Backslash.
      ...
      - **للنوع COMPREHENSION:** (نصوص القراءة في اللغات أو القصائد في العربي) ضع النص كاملاً مع كافة الأسئلة التابعة له ككتلة واحدة في حقل \`content\`، وضع الأجوبة النموذجية لكل الأسئلة في حقل \`rubric\`.
      - حدد الصعوبة من 1 إلى 5.
      - **مواضيع السؤال (topics):** استنتج مواضيع السؤال بدقة لتتطابق مع قوالب الامتحانات (مثل "دراسة تغيرات", "قواعد لغة", "قصيدة كذا").
      - للأسئلة المقالية والمسائل والنصوص، وفر rubric واضح ومفصل.
