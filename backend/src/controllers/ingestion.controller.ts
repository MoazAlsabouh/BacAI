...
export const uploadMaterial = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    if (type === 'TEMPLATE') {
      ...
      **هام جداً:** استخرج أكبر عدد ممكن من الأسئلة المتنوعة التي تغطي كافة أفكار وصفحات الملف بالكامل (استخرج من 30 إلى 50 سؤالاً على الأقل إن أمكن). لا تكتفي بتقديم عينة صغيرة فقط.
